<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login_to.aspx.cs" Inherits="Login_to" %>
	...
	<body>
		...
		<div class="wide">
			...
			<div class="right_bar" style="vertical-align: inherit;#999; ">
                <a href="Log.aspx" style="text-decoration: none;color:; font-size: 13px;">
         ...
         <div class="show_comm" style=" border:1px groove #808080;">
             ...
             <asp:Repeater ID="Repeater1" runat="server" 
                    ...
                    <div class="comm">
                     ...
                     <font style="color: #999; font-size: 12px"><br />版本:<%# Eval("Version")%></font><font style="color: #999; font-size: 12px"><br>库存:<%# Eval("Stock")%></font><font style="color: #999; font-size: 13px"><br>销售数量:<%# Eval("Sales")%></font><font style="color: #999; font-size: 12px"><br>好评:<%# Eval("Evaluate")%></font></div>
                      <div class="clik">
                    <div class="btn"><a href="Log.aspx" style="padding: 10px; margin: 10px; background-color: #4CCC76; color: #FFFFFF; font-size: 16px; font-family: Arial; font-weight: 300; text-decoration: blink; text-align: center; line-height: 2px; letter-spacing: 5px">+购买</a>
                          </div><div class="btn"><a href="#" style="padding: 10px; margin: 10px; background-color: #4CCC76; color: #FFFFFF; font-size: 16px; font-family: Arial; font-weight: 300; text-decoration: blink; text-align: center; line-height: 2px; ">+加入购物车</a>
