...
public partial class Pay2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/shoppingchrt.aspx");
    ...
    protected bool Can_Insert(string userid,string commname,string orderadress)
    {
        ...
        string connectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\shopping.mdf;Integrated Security=True;User Instance=True";
        //建立数据库连接
        string sql = @"INSERT INTO [order](OrderDate,UserId,CommodityId,OrderAdress,OrderIf,IfPayment) values(@now_date,@Userid,@commodityId ,@adress,'False','False');";
